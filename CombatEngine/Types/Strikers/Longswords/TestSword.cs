...
namespace Pilgrimage_Of_Embers.CombatEngine.Types.StrikerTypes.Longswords
{
    public class TestSword : BaseStriker
    {
        public TestSword() : base(CombatSlotType.OneHand, 130f, 30f, 100f) { }

        public override void Load(ContentManager main, ContentManager map)
        {
            swordTexture = main.Load<Texture2D>(strikerDirectory + "testSwordAnimation");
            baseScale = 2f;
