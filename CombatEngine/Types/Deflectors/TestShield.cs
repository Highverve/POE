...
namespace Pilgrimage_Of_Embers.CombatEngine.Types.DeflectorTypes
{
    public class TestShield : BaseDeflector
    {
        public TestShield()
            : base(CombatSlotType.OneHand, .4f, 15f)
        {
        ...
        {
            shieldTexture = main.Load<Texture2D>("Combat/Deflectors/shieldAnglesTest");
            baseScale = 2f;
